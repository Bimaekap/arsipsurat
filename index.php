          ...
          <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">KANTOR DINAS PENDIDIKAN KOTA BINJAI</span></a>
              </div>
          ...
          <div class="container">
            <div class="row">
              <div class="banner-info text-center wow fadeIn delay-05s">
                ...
                <h3 class="bnr-sub-title"><span class="logo-dec">PENDIDIKAN KOTA BINJAI</span></h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di Pemerintah Kota Samarinda</p>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; KANTOR DINAS PENDIDIKAN KOTA BINJAI. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
