    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        ...
        <ul class="nav side-menu">
          ...
          <li><a><i class="fa fa-users"></i> Manajemen Operator <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="#"><i class="fa fa-inbox"></i>Tambah Operator</a></li>
            </ul>
          </li>
          <li><a><i class="fa fa-users"></i> Laporan <span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li><a href="#"><i class="fa fa-inbox"></i>Laporan Surat</a></li>
            </ul>
          </li>
        </ul>
      </div>
